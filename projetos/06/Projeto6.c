...
int get_parametro_linha_comando(int argc, char *argv[], int *qtd_neuronios_ocultos);
...
void menu();
void projeto02(int qtd_neuronios_ocultos);
void projeto06(int qtd_neuronios_ocultos);
...
int main(int argc, char *argv[]) {
  ...
  menu(qtd_neuronios_ocultos);

  return 0;
}

void menu(int qtd_neuronios_ocultos){
  char item_selecionado = '0';
  printf("--------------------------------------------------------------\n");
  printf("1 - Criar arquivos de grama e asfalto\n");
  printf("2 - Ja existe arquivos de grama e asfalto, executar projeto 06\n");
  printf("--------------------------------------------------------------\n");
  scanf("%c", &item_selecionado);
  switch (item_selecionado) {
    case '1':
      projeto02(qtd_neuronios_ocultos);
      break;
    case '2':
      projeto06(qtd_neuronios_ocultos);
      break;
  }
}
...
int get_parametro_linha_comando(int argc, char *argv[], int *qtd_neuronios_ocultos){
  if (argc == 1){
    ...
    *qtd_neuronios_ocultos = atoi(argv[1]);
    return 1;
  }
}
